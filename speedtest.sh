...
_constant() {
    ...
    old_IFS="$IFS"
    work_dir="./sp-github-Syncony"
    node_set=""
    node_set_1="https://raw.githubusercontent.com/Syncony/speedtest/node/all-node.txt"
    node_set_2="https://hub.647777.xyz/https://raw.githubusercontent.com/Syncony/speedtest/node/all-node-mirror.txt"
    ...
    speedtest_cli_tar_url_2="https://hub.647777.xyz/https://raw.githubusercontent.com/Syncony/speedtest/asset/speedtest-cli/v${speedtest_cli_version}/ookla-speedtest-${speedtest_cli_version}-linux-${speedtest_cli_arch}.tgz"
    ...
    bim_core_tar_url_2="https://hub.647777.xyz/https://github.com/veoco/bim-core/releases/download/v${bim_core_version}/bimc-${bim_core_arch}-unknown-linux-musl"
    ...
    speedtest_go_tar_url_2="https://hub.647777.xyz/https://github.com/showwin/speedtest-go/releases/download/v${speedtest_go_version}/speedtest-go_${speedtest_go_version}_Linux_${speedtest_go_arch}.tar.gz"
    ...
    librespeed_cli_tar_url_2="https://hub.647777.xyz/https://github.com/librespeed/speedtest-cli/releases/download/v${librespeed_cli_version}/librespeed-cli_${librespeed_cli_version}_linux_${librespeed_cli_arch}.tar.gz"
...
_print_banner_1() {
    ...
    echo -e " GitHub                : ${green}https://github.com/Syncony/speedtest${endc}"
    printf "%-72s\n" "-" | sed 's)\s)-)g'
}
